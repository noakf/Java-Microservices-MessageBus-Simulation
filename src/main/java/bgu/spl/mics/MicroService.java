...
public abstract class MicroService implements Runnable {
    ...
    private final MessageBusImpl MBinstance;
    private final Map<Class<? extends Message>, Callback> messPerCB;
    ...
    protected final <T> Future<T> sendEvent(Event<T> e) {
        Future<T> F = MBinstance.sendEvent(e);
        return F;
    }
    ...
    public final void run() {
        ...
        while (!terminated) {
            try {
                ...
                Callback<Message> CB = messPerCB.get(message.getClass());
                if(CB != null) {
                    CB.call(message);
                }
